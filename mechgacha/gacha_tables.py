...
[
    ...
    PowerItem("loftyinclination:fivestar_automated_wiring_harness","Reaching, Grasping, Conductive Vines","Acting with a mind of its own, this old wiring harness will now seek out any nearby technology and infect it, syphoning energy and overriding command signals in any mechanised units, infastructure, or personnel that its own mind deems a target.", ["weapon"], stars=5),
